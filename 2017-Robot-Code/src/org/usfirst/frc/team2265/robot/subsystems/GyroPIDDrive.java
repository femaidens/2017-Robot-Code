 ...
 *
 */
public class GyroPIDDrive extends PIDSubsystem {
	...
	*/
	...
	public static PIDController pid = new PIDController(Kp,Ki,Kd,gyro,Drivetrain.frontLeft);

	//public double output, leftOutput, rightOutput;

...
public class RobotMap {
	...
	// Talon Ports
	public static int rearLeftPort = 1; //preseason 7
	public static int rearRightPort = 2; //4
	public static int frontLeftPort = 3; //3
	...
	//encoder ports
	public static int climberEncoderPort1 = 8;
